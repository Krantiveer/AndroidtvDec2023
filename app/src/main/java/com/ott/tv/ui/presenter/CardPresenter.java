...
/*        cardView.setFocusable(true);
    ...
    public void onBindViewHolder(Presenter.ViewHolder viewHolder, Object item) {
        ...
        if(video.getVideo_view_type().equalsIgnoreCase("Pay And Watch")){
            ((ViewHolder) viewHolder).mCardView.getTextPrimeView().setText("Pay And Watch");
        }else if(video.getVideo_view_type().equalsIgnoreCase("Free to Watch")){
            ((ViewHolder) viewHolder).mCardView.getTextPrimeView().setVisibility(View.GONE);
        }else{
            ((ViewHolder) viewHolder).mCardView.getTextPrimeView().setText("Premium");
