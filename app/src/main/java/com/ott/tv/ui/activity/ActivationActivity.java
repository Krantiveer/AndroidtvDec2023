...
import com.ott.tv.network.api.ActivationApi;
import com.ott.tv.network.api.SubscriptionApi;

import static com.ott.tv.fragments.TvSplashFragment.COMPLETED_SPLASH;
...
public class ActivationActivity extends Activity {
    ...
    private void validateCode() {
        ...
        Log.d("kranti","ActivationAcitivity"+getApplicationContext());
    ...
    private void updateSubscriptionStatus(String userId) {
        ...
        Log.d("kranti","ActivationActivity");
