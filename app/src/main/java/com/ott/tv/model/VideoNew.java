 ...
 */
public final class VideoNew implements Parcelable {
    ...
    public static Creator<VideoNew> getCREATOR() {
        return CREATOR;
    }
    ...
    public static final Creator<VideoNew> CREATOR = new Creator<VideoNew>() {
        @Override
        public VideoNew createFromParcel(Parcel in) {
            return new VideoNew(in);
        }

        @Override
        public VideoNew[] newArray(int size) {
            return new VideoNew[size];
        }
    };

    @Override
    public boolean equals(Object m) {
        return m instanceof VideoNew && id == ((VideoNew) m).id;
    }
    ...
    public static class VideoBuilder {
        ...
        public VideoNew buildFromMediaDesc(MediaDescription desc) {
            return new VideoNew(
