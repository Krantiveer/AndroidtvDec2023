...
public class LatestMoviesTVSeriesList implements Parcelable {
    ...
    public static final Creator<LatestMoviesTVSeriesList> CREATOR = new Creator<LatestMoviesTVSeriesList>() {
        @Override
        public LatestMoviesTVSeriesList createFromParcel(Parcel in) {
            return new LatestMoviesTVSeriesList(in);
        }

        @Override
        public LatestMoviesTVSeriesList[] newArray(int size) {
            return new LatestMoviesTVSeriesList[size];
        }
    };
