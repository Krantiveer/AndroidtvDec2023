...
public class HomeBannerSecAdapterbottomVertical extends RecyclerView.Adapter<HomeBannerSecAdapterbottomVertical.ViewHolder> {
    private BrowseData listdata;
    private Context context;

    public HomeBannerSecAdapterbottomVertical(BrowseData listdata, Context context) {
    ...
    public HomeBannerSecAdapterbottomVertical.SendInterfaceClickSec sendInterfaceClickSec;

    public void setSendInterfaceClick(HomeBannerSecAdapterbottomVertical.SendInterfaceClickSec sendInterfaceClick) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View listItem = layoutInflater.inflate(R.layout.banner_home_list_item_vertical, parent, false);
    ...
    public SendInterfaceDataBottom SendInterfaceDataBottomVertical;

    public void setSendInterfacedata(SendInterfaceDataBottom SendInterfaceDataBottom) {
        this.SendInterfaceDataBottomVertical = SendInterfaceDataBottom;
    }
            ...
            holder.relativeLayout_parent.setOnFocusChangeListener((view, b) -> {
                if (listdata.getList().get(position).getTitle() != null) {
                    ...
                    if (SendInterfaceDataBottomVertical != null) {
                        SendInterfaceDataBottomVertical.sendDescriptionBottom(listdata.getList().get(position));
                    }
                }
            });
        }
